...
These Terms of Service ("**Terms**") form a binding agreement between you ("**you**" or "**User**") and Future Think LLC ("**SignDay**," "**we**," "**us**," or "**our**"). By subscribing to or using the SignDay website and service at signdayapp.com (the "**Service**"), you agree to these Terms and to our [Privacy Policy](./privacy-policy.md).
...
- Weekly monitoring of the college programs you choose to track (roster, coaching staff, and recent results)
- A school tracker where you record the status of each coach conversation
- AI-drafted coach-outreach emails based on the athlete's profile and publicly available program information
- A weekly email digest summarizing what changed and the drafts ready for your review
...
- Is generated automatically from the inputs available to the Service
- May contain factual errors, omissions, or misleading information
- Is **not** professional recruiting advice, legal advice, or a guarantee of any outcome
- Must be **reviewed and edited by you** before you send it
...
You agree **not** to:
- Misrepresent your identity or authority to provide an athlete's information
- Use the Service to harass, threaten, or harm any person, including college coaches
- Send spam or unsolicited bulk email using drafts generated by the Service
- Use the Service to violate NCAA, NAIA, or other recruiting rules
- Attempt to reverse engineer, decompile, or extract the Service's source code, or scrape or harvest data from the Service
- Interfere with the Service's operation or security, or access it by automated means
...
- **Entire agreement:** These Terms and the Privacy Policy are the entire agreement between you and SignDay regarding the Service.
- **Severability:** If any provision is unenforceable, the remaining provisions remain in effect.
- **No waiver:** Our failure to enforce a provision is not a waiver of our right to do so later.
- **Assignment:** You may not assign these Terms without our written consent; we may assign them in connection with a merger, acquisition, or sale of assets.
- **Notices:** We may send notices by email or by posting on signdayapp.com. Send legal notices to 788 North Oak Drive, Bronx, NY 10467.
- **Force majeure:** We are not liable for failures caused by events beyond our reasonable control, including outages of third-party services.
