...
function buildLeadEmail(
  ...
  t.push(``);
  t.push(`$19.99/month, cancel anytime. Start here: ${origin}/?utm_source=demo_email`);
  t.push(``);
  t.push(`Tony @ SignDay`);
  ...
  h.push(`<div style="color:#6B7280; font-size:13px; margin-top:4px;">$19.99/month · cancel anytime, one click · no contract</div>`);
